...
//    	autoDrivePIDCommand = new AutoDrivePID();
    	AutoPassDefence = new AutoDriveForwardCount(700);
...
//    	autoChooser.addObject("Drive To Defence", new AutoDriveForwardCount(200));
    ...
    public void autonomousInit() {
    	drivetrain.ptoOff();
    	drivetrain.shiftLow();
    	navigation.chooseAuto();
    /*	
    	if(navigation.auto == 1){
    		AutoPassLowBar.start();
    	}
    	else if(navigation.auto == 2){
    		AutoPassDefence.start();
    	}
    	else if(navigation.auto == 3){
    		AutoLowBarAndBack.start();
    	}
    	else if(navigation.auto == 4){
    		AutoDefenceAndBack.start();
    	}
    	else if(navigation.auto == 5){
    	...
    	/*
    	switch(navigation.auto){//navigation.chooseAuto()
    		case 1:
    			AutoPassLowBar.start();
    			break;
    		case 2:

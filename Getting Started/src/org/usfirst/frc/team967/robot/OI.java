...
import org.usfirst.frc.team967.robot.commands.ClimberToExtended;
...
/*    	JoystickButton board_1 = new JoystickButton(board, 1);
  ...
  */  	
    	...
    	xbox1_a.whenReleased(new Shoot(0));
    	xbox1_b.whenPressed(new ClimberUp());
    	xbox1_b.whenReleased(new ClimberStopExtention());
//        xbox1_x.whenPressed(new Shoot());     
    	xbox1_y.whenPressed(new SwitchArcadeDriveDirection());
    	
    	//*****************************************************
    	//Xbox2************************
    	xbox2_start.whenPressed(new ClimberToExtended());//ToggleClimbMode());
...
//    	SmartDashboard.putData("Reach Defences Auto", new ReachDefencesAuto());
    	SmartDashboard.putBoolean("A Button 1", xbox1.getRawButton(1));
    }
